...
from protos import minimal_pb2 as minimal__pb2
...
class UnaryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetServerResponse = channel.unary_unary(
                '/minimal.Unary/GetServerResponse',
...
def add_UnaryServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'minimal.Unary', rpc_method_handlers)
...
class Unary(object):
    ...
    def GetServerResponse(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/minimal.Unary/GetServerResponse',

...
class {{cookiecutter.service_name}}_Implied_Services_Request_Manager(Implied_Services_Request_Manager):
    ...
    def get_available_services(self) -> List[str]:
        log.debug("In {{cookiecutter.service_name}}_Implied_Services_Request_Manager, get_available_services")
        return get_services_list.execute()

    def get_implicit_service_manager(self, service : str) -> Callable:
        log.debug("In {{cookiecutter.service_name}}_Implied_Services_Request_Manager, get_implicit_service_manager")

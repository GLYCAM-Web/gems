    ...
    def process(self) -> list[AAOP]:
        ...
        for i, aaop in enumerate(self.aaop_list):
            if aaop.AAO_Type == "AmberMDPrep":
                # I believe this should be done by the ProjectManagement service.
                ...
                # update output file name from the input file name - This will most likely be saved in the project directory.
                if (

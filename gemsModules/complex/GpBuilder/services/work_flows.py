from gemsModules.common.services.workflow_manager import Service_Work_Flows_GpBuilder
from gemsModules.common.services.workflow_manager import Service_Work_Flow_Order_GpBuilder

from gemsModules.logging.logger import Set_Up_Logging
log = Set_Up_Logging(__name__)


def get_Service_Work_Flows() -> Service_Work_Flows_GpBuilder:
    """ Return services work Flows data
    """

    from gemsModules.complex.GpBuilder.services import marco
    from gemsModules.complex.GpBuilder.services import list_services
    from gemsModules.complex.GpBuilder.services import Build
    ...
    Service_Work_Flows = Service_Work_Flows_GpBuilder
    
    Service_Work_Flows.append(Service_Work_Flow_Order_GpBuilder(
        "error", 
        error_list
            ))
    Service_Work_Flows.append(Service_Work_Flow_Order_GpBuilder(

...
class batchcompute_Implied_Services_Request_Manager(Implied_Services_Request_Manager):
    ...
    def get_available_services(self) -> List[str]:
        log.debug("In batchcompute_Implied_Services_Request_Manager, get_available_services")

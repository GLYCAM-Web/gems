...
from ...main_api import Antibody_Service_Request, Antibody_Service_Response
from gemsModules.common.main_api_resources import Resource, Resources
from gemsModules.complex.antibody.services.common_api import PDB_File_Resource
...
class ProjectManagement_Request(Antibody_Service_Request):
...
class ProjectManagement_Response(Antibody_Service_Response):
    typename: str = Field("ProjectManagement", alias="type")

...
# source: Web_Programs/gems/gRPC/TESTCONN/protos/minimal.proto
...
Message = _reflection.GeneratedProtocolMessageType('Message', (_message.Message,), {
  'DESCRIPTOR' : _MESSAGE,
  '__module__' : 'Web_Programs.gems.gRPC.TESTCONN.protos.minimal_pb2'

...
from gemsModules.TEMPLATE.services.settings.duplicates_modules import duplicates_modules 

from gemsModules.logging.logger import Set_Up_Logging
log = Set_Up_Logging(__name__)

class template_Duplicate_Requests_Manager(Duplicate_Requests_Manager):

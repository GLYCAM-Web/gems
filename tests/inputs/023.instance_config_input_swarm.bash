...
declare -A PreconfigName # This is for use in the test rather than being part of the test
PreconfigName=(
	["MD"]="MDaaS-RunMD_preconfig-git-ignore-me.json"
	["GM"]="Glycomimetics_preconfig-git-ignore-me.json"
	["AD"]="AntibodyDocking_preconfig-git-ignore-me.json"
	["GP"]="GlycoProtein_preconfig-git-ignore-me.json"
	)

## These arrays correspond to parts of the instance config
# For now, I am making these names be descriptive here in this test, but will not (yet) change the names used in GEMS
...
declare -A RedirectionHostPorts  # ""
                                 # This would be an entry in RedirectionHostPorts:  AD_JSON_PORT=42031 # UNUSED currently, but needs to be set for AD.
...
declare -A RemoteWorkingPathHead # The parent directory for working directories on the remote machine 
				 ...
				 # I think this is mainly used for generating mounts, but that information does not belong in GEMS.

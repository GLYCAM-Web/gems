...
from gemsModules.TEMPLATE.services.settings.implied_modules import implied_modules 

from gemsModules.logging.logger import Set_Up_Logging
log = Set_Up_Logging(__name__)


class template_Implied_Services_Request_Manager(Implied_Services_Request_Manager):
    ...
    def get_available_services(self) -> List[str]:
        log.debug("In template_Implied_Services_Request_Manager, get_available_services")
        return get_services_list.execute()

    def get_implicit_service_manager(self, service : str) -> Callable:
        log.debug("In template_Implied_Services_Request_Manager, get_implicit_service_manager")

...
class Batchcompute_Response_Manager(Response_Manager):

    def populate_response_entity(self, existing_response_entity):
        log.info("populate_response_entity for Batchcompute_Response_Manager is called")
    ...
    def generate_response_entity(self):
        self.response_entity = Batchcompute_Entity(type="batchcompute")

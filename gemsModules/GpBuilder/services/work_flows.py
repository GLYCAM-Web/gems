...
def get_Service_Work_Flows() -> Service_Work_Flows_GpBuilder:
    ...
    from gemsModules.GpBuilder.services import marco
    from gemsModules.GpBuilder.services import list_services
    from gemsModules.GpBuilder.services import Build

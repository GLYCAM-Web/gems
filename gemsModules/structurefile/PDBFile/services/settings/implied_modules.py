...
REGISTRY = {
    ...
    "ListServices": ModuleData('gemsModules.common.services.list_services.implied_translator', 'list_services_Implied_Translator'),
    "Status": ModuleData('gemsModules.common.services.status.implied_translator', 'status_Implied_Translator'),
    "AmberMDPrep": ModuleData('gemsModules.structurefile.PDBFile.services.AmberMDPrep.implied_translator', 'AmberMDPrep_Implied_Translator'),
    "ProjectManagement": ModuleData('gemsModules.structurefile.PDBFile.services.ProjectManagement.implied_translator', 'ProjectManagement_Implied_Translator'),
}

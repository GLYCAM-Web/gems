...
from gemsModules.complex.antibody.services.settings.implied_modules import (
    implied_modules,
)
...
class Antibody_Implied_Services_Request_Manager(Implied_Services_Request_Manager):

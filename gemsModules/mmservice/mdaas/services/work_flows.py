...
def get_Service_Work_Flows() -> Service_Work_Flows_template:
    ...
    from gemsModules.mmservice.mdaas.services import marco
    from gemsModules.mmservice.mdaas.services import list_services
    ...
    Service_Work_Flows.append(Service_Work_Flow_Order_template("run_md", run_md_list))

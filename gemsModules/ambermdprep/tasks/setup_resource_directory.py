...
def execute(protocol_files_dir : str, output_dir_path : str, uploads_dir_path : str,
            parm7_real_name : str, rst7_real_name : str, 
            parm7_protocol_name : str = 'mdInput.parm7', rst7_protocol_name : str = 'mdInput.rst7'):

    # ensure that the protocol files directory exists
    if filesystem_ops.directory_exists(protocol_files_dir) == False:
        raise Exception('Protocol files directory does not exist: ' + protocol_files_dir)

...
class Glycomimetics_Response_Manager(Response_Manager):

    def populate_response_entity(self, existing_response_entity):
        log.info("populate_response_entity for Glycomimetics_Response_Manager is called")
        ...
        for aaop in request_aaop_list:
            ...
            self.response_entity.services.add_service(
        ...
        for aaop in response_aaop_list:
            ...
            self.response_entity.responses.add_response(
    ...
    def generate_response_entity(self):
        self.response_entity = Glycomimetics_Entity(type="Glycomimetics")

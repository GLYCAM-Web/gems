...
PROJECT_DIR=$(./bin/delegate gemsModules/complex/antibody/tests/inputs/explicit_evaluate-thoreau.json | tee ad2_remote_test_eval_output-git-ignore-me.txt | grep -Po '"project_dir":\s*"\K[^"]*')\
